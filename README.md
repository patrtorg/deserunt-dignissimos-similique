...
![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/reduxjs/@patrtorg/deserunt-dignissimos-similique/test.yml?branch=master)
[![npm version](https://img.shields.io/npm/v/@patrtorg/deserunt-dignissimos-similique.svg?style=flat-square)](https://www.npmjs.com/package/@patrtorg/deserunt-dignissimos-similique)
[![npm downloads](https://img.shields.io/npm/dm/@patrtorg/deserunt-dignissimos-similique.svg?style=flat-square)](https://www.npmjs.com/package/@patrtorg/deserunt-dignissimos-similique)
...
If you're using the basic Redux `createStore` API and need to set this up manually, first add the `@patrtorg/deserunt-dignissimos-similique` package:

```sh
npm install @patrtorg/deserunt-dignissimos-similique

yarn add @patrtorg/deserunt-dignissimos-similique
```
...
```js
import { thunk } from '@patrtorg/deserunt-dignissimos-similique'
```

If you use Redux Thunk in a CommonJS environment:

```js
const { thunk } = require('@patrtorg/deserunt-dignissimos-similique')
```
